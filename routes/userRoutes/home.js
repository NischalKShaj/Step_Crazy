...
router.get("/profile/add-adderss",usersAuth.userAuth, ProfileController.getAddressAdd);

// router for showing the users address
router.get("/profile/address",usersAuth.userAuth, ProfileController.getAddressPage);

// router for editing the address of the user
router.get("/profile/address/edit/:id",usersAuth.userAuth, ProfileController.getAddressEdit);
...
router.post("/profile/editProfile/:id", usersAuth.userAuth,ProfileController.postProfileEdit);

// router for moving to the checkout page
router.get("/product/cart/checkout", usersAuth.userAuth,cartController.getCheckout);
...
router.get("/cart/remove/:id", usersAuth.userAuth,cartController.deleteProduct);

// router for increasing and decreasing the stock
router.post("/product/cart/update/:productId", usersAuth.userAuth,cartController.putStock);
...
router.get("/order/returnOrder/:id", usersAuth.userAuth,orderController.getReturnOrder);
...
router.get("/product/wishlist/:id", usersAuth.userAuth,wishlistController.addToWishlist);

// router for removing the product from the wishlist
router.get("/wishlist/remove/:id", usersAuth.userAuth,wishlistController.getRemoveProduct);
...
router.post("/onlinepayment", usersAuth.userAuth,orderController.postOnlinePayment);

// router for posting the order confirmation page
router.post("/product/order", usersAuth.userAuth,orderController.postOnlineConfirm);

// router for wallet payment
router.get("/product/order/wallet", usersAuth.userAuth,orderController.getWalletPayment);
...
router.post("/product/cart/coupon", usersAuth.userAuth,orderController.checkCoupons);
